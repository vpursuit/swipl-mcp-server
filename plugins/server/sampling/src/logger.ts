/**
 * Centralized logging utility for MCP sampling operations
 *
...
export class Logger {
  ...
  child(prefix: string): Logger {
    ...
    childLogger.level = this.level; // Inherit parent's log level
    return childLogger;
  }
...
/**
 * Default logger instance for sampling operations
 */
export const samplingLogger = new Logger("Sampling");
