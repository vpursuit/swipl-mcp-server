...
|---------|---------|---------|------|------------|
| [@vpursuit/swipl-mcp-server](https://www.npmjs.com/package/@vpursuit/swipl-mcp-server) | 2.0.1 | BSD-3-Clause | ≥20.0.0 | [GitHub](https://github.com/vpursuit/swipl-mcp-server) |
